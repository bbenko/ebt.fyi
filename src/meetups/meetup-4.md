---
title: "EBT #4: Practical AI for Founders, Developers & Operators"
meetupId: 4
meetupDate: 2026-06-26
meetupTime: 6:00 PM
...
luma:
  eventId: evt-cqyD6PlLTQ4CgLK
  eventUrl: https://luma.com/cs9d2o3h
heroArt:
  - /assets/artificialanalysis-intelligence-vs-cost-2026-06-26.png
  - /assets/glm-5-2-long-horizon-benchmarks-2026.png
  - /assets/claude-opus-4-8-benchmarks-2026.png
---
...
<figure>
  <img src="/assets/artificialanalysis-intelligence-vs-cost-2026-06-26.png" alt="Artificial Analysis chart from June 26, 2026 comparing intelligence versus cost to run across AI models." />
...
<figure>
  <img src="/assets/claude-opus-4-8-benchmarks-2026.png" alt="Anthropic benchmark chart comparing Claude Opus 4.8 with prior Claude models and other AI models across coding, agentic, reasoning, and knowledge-work tasks." />
  <figcaption>Anthropic's Opus 4.8 article includes a benchmark comparison across coding, agentic tasks, reasoning, and professional work.</figcaption>
</figure>
...
<figure>
  <img src="/assets/glm-5-2-long-horizon-benchmarks-2026.png" alt="Z.ai benchmark chart comparing GLM-5.2 with other frontier and open models on long-horizon coding tasks." />
  <figcaption>Z.ai's GLM-5.2 benchmarks frame open models as contenders for long-running coding-agent work, not just cheaper chat completions.</figcaption>
</figure>
...
- Contrast that with this [YouTube Short](https://www.youtube.com/shorts/DMVkTY0kJI8) as the sharper automation argument: if AI can handle more entry-level work, what still justifies hiring and training juniors?
...
<figure>
  <img src="/assets/matt-garman-junior-developers-youtube-short.jpg" alt="YouTube Short thumbnail showing Ken Griffin on stage with text about AI agents and task completion." />
  <figcaption>The YouTube Short gives the automation side of the junior-developer debate a concrete visual prompt.</figcaption>
</figure>
