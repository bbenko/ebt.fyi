---
title: "East Bay Tech #2: Practical AI for Founders, Developers & Operators"
meetupId: 2
meetupDate: 2026-04-17
meetupTime: 6:00 PM
location: Lafayette, California
summary: A curated East Bay AI gathering for founders, developers, and operators focused on practical conversations, strong local connections, and real use cases.
agendaIntro: "A small East Bay meetup for founders, developers, and operators who want honest, practical conversations about how AI is changing real work."
highlights:
  - Honest discussion about what is working, what is not, and what is changing fast.
  - A strong local mix of founders, developers, and operators.
  - Useful conversations that can lead to new ideas, context, and relationships.
sessionPlan:
  - Small, discussion-first format.
  - Topics will be finalized closer to the event.
  - Bring a use case, lesson, or question from your work.
luma:
...
<figure>
  <img src="/assets/artificialanalysis-intelligence-vs-cost-2026-04-16.svg" alt="Artificial Analysis chart from April 16, 2026 comparing intelligence versus cost to run across frontier AI models." />
  <figcaption>Artificial Analysis model snapshot, captured April 16, 2026.</figcaption>
</figure>
...
- There is also a useful [Hacker News thread](https://news.ycombinator.com/item?id=47677853) for a faster read on market reaction.
...
### [Introducing Muse Spark](https://ai.meta.com/blog/introducing-muse-spark-msl/)
...
<figure>
  <img src="/assets/google-ai-edge-gallery-gemma-4-iphone.svg" alt="Mobile screenshot of Google AI Edge Gallery showing Gemma 4 on-device use cases including AI Chat, Agent Skills, Ask Image, and Audio Scribe." />
  <figcaption>Google AI Edge Gallery positioning Gemma 4 as an on-device model for mobile AI chat, agent skills, and multimodal tools.</figcaption>
</figure>
...
<figure>
  <img src="/assets/agents-by-domain-tool-calls-2026.svg" alt="Monospace chart of agent deployment by domain showing software engineering as the largest category at 49.7 percent of tool calls, followed by back-office automation at 9.1 percent and other categories in smaller shares." />
  <figcaption>Agent deployment by domain, added as a discussion prompt alongside the Sequoia services-as-software argument.</figcaption>
</figure>
...
### [Powell, Bessent flag systemic risk from advanced AI models](https://investinglive.com/centralbank/powell-bessent-flag-systemic-risk-from-advanced-ai-models-20260410/)
...
### [OpenAI CEO Sam Altman attack coverage](https://www.npr.org/2026/04/13/g-s1-117320/openai-sam-altman-molotov-cocktail)
...
### [CNN on Anthropic's Mythos rollout](https://www.cnn.com/2026/04/07/tech/anthropic-claude-mythos-preview-cybersecurity)
...
### [coding-assistants.rst in the Linux kernel tree](https://github.com/torvalds/linux/blob/master/Documentation/process/coding-assistants.rst)
